...
\centering%
\subfloat{{
 \includegraphics[scale=0.3]{./figures/interface_energies.png}
 }}%
\subfloat{{
 \includegraphics[scale=0.7]{figures/NOTINOQMD_00002-GSF_111.png}
 }}%
\\
\subfloat{{
 \includegraphics[scale=1.0]{figures/GSF_ThetaDP111_surf.png}
 }}%
\end{figure}
