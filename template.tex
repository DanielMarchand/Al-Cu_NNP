...
Firstly, we reshape the base cell to find the smallest cell such that a1 and a2 lie exactly on the plane of interest, with a3 going out of the plane.
...
The GSFE of the ADP potential, conversely, is substantially less smooth; there is also a noticeable lack of radial symmetry and high and low energy sites,  with a number of sharp ridges extending across high energy regions.
...
Firstly, we see that by this time, including structures in the training set, we attain a very high accuracy in the GSF energy. 
...
Antisites and Vacancies were computed for every OQMD structure in the following manner.
