...
%with volume $V$, the equilibrium volume at T=0K $V^{\rm eq}_0$, the isothermal bulk modulus $B_{T,0}$ and the pressure derivative of the isothermal bulk modulus $B_{T,0}'$.  
...
%$E^{4Cu}_{Unrelaxed}$(eV)&0.322& 2.166 & 0.435&0.464&0.451 &\emph{0.576 / 0.093}&  \includegraphics[width=0.07\textwidth]{figures/SoluteCluster_111122.png}\\%
...
\begin{table}[H]
	...
	\begin{tabular}{l|ccccccV}
\hline%
		Jump type  & \multicolumn{6}{c}{Migration energy [eV]}  &                   \\
		\cmidrule(r){2-7}
...
\bibliography{references,ref} %%% Remove comment to use the external .bib file (using bibtex).
